          ...
          <input
            ...
            placeholder={
              viewMode === "devis"
                ...
                : "Rechercher une facture ou un client…"
            }
            value={search}
            ...
            filteredQuotes.length === 0 ? (
              <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
                ...
                <p className="text-slate-300 text-sm mt-1">
                  Appuyez sur + pour créer votre premier devis
                </p>
              </div>
            ) : (
                ...
                >
                  <div className="p-5">
                    <div className="flex justify-between items-start mb-2">
                      <p className="font-bold text-slate-900 truncate pr-3">
                        {quote.client_name}
                      </p>
                      <span
                  ...
                  <div className="p-5 flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-slate-900 truncate">
                        {inv.clients?.nom ?? "Client inconnu"}
                      </p>
                    ...
                    <div className="text-right flex-shrink-0">
                      <p className="font-black text-slate-900">
                        {Number(inv.montant_ttc).toFixed(2)} €
                      </p>
                      <span
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl text-center">
            ...
            <p className="text-slate-500 mb-6 text-sm">
              Cette action est irréversible pour le devis de{" "}
              <strong>{quoteToDelete.client_name}</strong>.
            </p>
            <div className="flex flex-col gap-3">
              <button
                onClick={confirmDelete}
                className="w-full py-4 bg-red-500 text-white rounded-2xl font-bold shadow-lg shadow-red-100"
              >
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-white rounded-3xl p-8 w-full max-w-sm shadow-2xl text-center">
            ...
            <button
              ...
              className="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold mb-2 shadow-lg"
            >
              Déconnexion
            </button>
            <button
